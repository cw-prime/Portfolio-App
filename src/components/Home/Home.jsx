...
const Home = () => {
  ...
  <div className="home-container">
    <div className="main-content">
      <p>Welcome! I'm Mark Alan, a seasoned web developer with a passion for creating innovative and interactive web applications.</p>
      <p>My journey in web development has equipped me with a robust skill set and a comprehensive understanding of the latest technologies. I thrive on tackling complex challenges and transforming ideas into reality.</p>
      <p>My commitment to excellence extends to every project I undertake. Whether it's crafting a user-friendly interface, optimizing performance, or implementing cutting-edge features, I approach each task with precision and creativity.</p>
    </div>
  </div>
...
<section id="experience" className="experience">
        ...
        <div id="experience-container" className="experience-container">
          <div className="marquee-container">
            <img src="/assets/charter_spectrum_logo.png" alt="Charter Spectrum Logo" />
            <img src="/assets/suntrust_bank_logo.png" alt="Suntrust Bank Logo" />
  ...
  <div className="portfolio-grid">
    ...
    <div className="portfolio-item">
      ...
      <section id="contact" className="contact">
        ...
        <h2>Contact Me</h2>
        <p>Let's work together! Feel free to reach out through the contact form below.</p>
